    ...
    <div class="footer-main text-white py-5">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex gap-2 mt-2">
                        ...
                        <a
                            ...
                            class="text-white hover-green fs-5"
                ...
                <!-- Links -->
                <div class="col-md-4">
                    <h5 class="fw-bold mb-3">Meniu</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="/" class="text-white hover-green">Acasă</a>
                        </li>
                        <li class="mb-2">
                            <a href="/despre-noi" class="text-white hover-green"
                                >Despre Noi</a
                            >
                        </li>
                        <li class="mb-2">
                            <a href="/produse" class="text-white hover-green"
                                >Produse</a
                            >
                        </li>
                        <li class="mb-2">
                            <a href="/contact" class="text-white hover-green"
                                >Contact</a
                            >
                        </li>
                        <li class="mb-2">
                            <a href="/horeca" class="text-white hover-green"
                                >HoReCA</a
                            >
                        </li>
                        <li class="mb-2">
                            <a href="/noutati" class="text-white hover-green"
                                >Noutăți</a
                            >
                        </li>
                        <li class="mb-2">
                            <a href="/cos" class="text-white hover-green">Coș</a
                            >
                        </li>
                    </ul>
                </div>
                ...
                <!-- Location -->
                <div class="col-md-4">
                    <h5 class="fw-bold mb-3">Locația Noastră</h5>
                    <p class="small mb-2">
