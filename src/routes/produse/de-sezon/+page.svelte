  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-lg-8 mx-auto">
        ...
        <p>
          Din cei 2500 mp de solarii ce îi deținem noi dar și din fermele
          celorlalți producători de seamă cu care colaboram, aducem zilnic la
          Rulota DeSaga o gamă largă de legume și fructe DE SEZON.
        </p>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <p class="small">
                  dovlecel, zucchini, gulie, varză timpurie, salată, fasole
                  păstăi, mazăre, ceapă verde, usturoi verde, leurdă, mărar,
                  pătrunjel, ridichi, spanac, țelină, cartofi noi, castraveți,
                  căpșuni, cireșe
                </p>
              </div>
              <div class="col-md-6">
                ...
                <p class="small">
                  roșii, roșii Cherry, zarzavaturi, ardei, dovlecel, vinete,
                  cartofi, castraveți, varză, ceapa, usturoi, sfeclă roșie,
                  țelină, fasole, verdeață, porumb dulce, mere de vară, pere,
                  prune, caise, piersici, vișine, zmeură, afine, coacăze, mure,
                  pepene
                </p>
              </div>
            </div>
            ...
            <div class="row mt-3">
              <div class="col-md-6">
                ...
                <p class="small">
                  sfecla roșie, varză, conopida, broccoli, fasole boabe,
                  gogoșar, ardei capia, ardei gras, ardei iute, morcovi,
                  pătrunjel, țelină, cartofi, hrean, ceapă, usturoi, dovleac,
                  roșii, gogonele, castraveți, mere, pere, gutui, nuci, prune,
                  struguri
                </p>
              </div>
              <div class="col-md-6">
                ...
                <p class="small">
                  morcovi, pătrunjel, țelină, cartofi, sfecla, usturoi, dovleac,
                  mere, pere, nuci
                </p>
              </div>
            </div>
